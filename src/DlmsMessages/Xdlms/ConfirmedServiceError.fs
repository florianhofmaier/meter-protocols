...
module ServiceErrorRaw =
    ...
    let parse : Parser<ServiceErrorRaw> =
        ...
        parser {
            let! tag = DlmsMessages.Tag.parse<Tag>
            let! value = parseU8
...
module ConfirmedServiceErrorRaw =
    ...
    let parseBody : Parser<ConfirmedServiceErrorRaw> =
        parser {
            let! tag = DlmsMessages.Tag.parse<ChoiceTag>
...
module ApplicationReferenceError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "application-reference"]
...
module HardwareResourceError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "hardware-resource"]
...
module VdeStateError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "vde-state-error"]
...
module ServiceError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "service"]
...
module DefinitionError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "definition"]
...
module AccessError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "access"]
...
module InitiateError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "initiate"]
...
module LoadDataSetError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "load-data-set"]
...
module TaskError =
    let fromRaw value =
        ...
        | other ->
            Validation.error
                ["ConfirmedServiceError"; "service-error"; "task"]
